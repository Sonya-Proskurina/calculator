...
class CalculatorBloc extends Bloc<CalculatorEvent, CalculatorState> {
  static List<ButtonEntities> buttons = [
    ...
    ButtonEntities(buttons: [
      ...
      ButtonBodyEntities.forName(name: "sin^-1", eventText: "asin"),
    ]),
    ButtonEntities(buttons: [
      ButtonBodyEntities.forName(name: "5", eventText: "5"),
      ButtonBodyEntities.forName(name: "cos^-1", eventText: "acos"),
    ]),
    ButtonEntities(buttons: [
      ButtonBodyEntities.forName(name: "6", eventText: "6"),
      ButtonBodyEntities.forName(name: "tg^-1", eventText: "atg"),
    ]),
    ButtonEntities(buttons: [
      ButtonBodyEntities.forName(name: "-", eventText: "-"),
        ...
        switch (event.name) {
          ...
          case ".":
            if (sizeMantissa+1<=8&&textMantissa[0]!="0") {
              if (isNumber(textMantissa[textMantissa.length-1])||isEPi(textMantissa[textMantissa.length-1])) {
                textMantissa.add(event.name);
